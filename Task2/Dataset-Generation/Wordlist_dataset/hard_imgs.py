...
train_output_dir = 'Task2/wordlist_captcha_images/train/hard'
test_output_dir = 'Task2/wordlist_captcha_images/test/hard'
...
# training images
output_file_path = os.path.join("Task2/wordlist_captcha_images/train", 'labels_hard.csv')
i = 0
...
# Test images
output_file_path = os.path.join('Task2/wordlist_captcha_images/test', 'labels_hard.csv')
i = 0
with open(output_file_path, mode = 'w', newline = '') as file:
    writer = csv.writer(file)
    writer.writerow(['filename', 'label'])
