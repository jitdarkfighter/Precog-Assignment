...
train_output_dir = 'Task2/captcha_images/train/easy'
test_output_dir = 'Task2/captcha_images/test/easy'
...
def generate_random_word():
    """Generate a random word of 5-8 letters"""
...
#Train datasets
output_file_path = os.path.join("Task2/captcha_images/train", 'labels_easy.csv')
i = 0
...
#Test Datasets
output_file_path = os.path.join("Task2/captcha_images/test", 'labels_easy.csv')
i = 0
with open(output_file_path, mode = 'w', newline = '') as file:
    writer = csv.writer(file)
    writer.writerow(['filename', 'label'])
